...
def _looks_tabular(block: str) -> bool:
    ...
    Tables align columns with runs of whitespace, so most of their lines contain
    an interior gap of 3+ spaces. Prose, being hard-wrapped, does not — its only
    multi-space runs are the paragraph indent at the start of a line.
    """
